...
a persistence unit "examenalvarezcarlosservidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenalvarezcarlosservidor\pom.xml":
...
artifact ("examenalvarezcarlosservidor.war") is already built. You can build
